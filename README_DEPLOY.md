...
- 프로젝트 경로: `/home/sam/workspace/dev_wiki`
- 빌드 산출물: `/home/sam/workspace/dev_wiki/build`
- 현재 테스트 접속 주소: `http://100.100.1.100:3000/wiki/`
- 목표 서비스 경로: `http://100.100.1.100/wiki/` 또는 `https://100.100.1.100/wiki/`
...
redir /wiki /wiki/ 308
handle_path /wiki/* {
    root * /home/sam/workspace/dev_wiki/build
